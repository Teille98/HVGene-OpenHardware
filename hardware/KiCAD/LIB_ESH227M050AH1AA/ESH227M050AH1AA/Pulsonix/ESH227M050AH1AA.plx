...
//396246/1514719/2.50/2/3/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "CAPPRD500W60D1000H1350" (originalName "CAPPRD500W60D1000H1350")
		(multiLayer
	...
	(symbolDef "ESH227M050AH1AA" (originalName "ESH227M050AH1AA")
	...
	(compDef "ESH227M050AH1AA" (originalName "ESH227M050AH1AA") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ESH227M050AH1AA"))
		(attachedPattern (patternNum 1) (patternName "CAPPRD500W60D1000H1350")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "80-ESH227M050AH1AA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/ESH227M050AH1AA?qs=w9hhVRgtvfmnb2YOvt619g%3D%3D")
		(attr "Manufacturer_Name" "KEMET")
		(attr "Manufacturer_Part_Number" "ESH227M050AH1AA")
		(attr "Description" "Kemet 220uF Electrolytic Aluminium Electrolytic Capacitor 50V dc, Through Hole - ESH227M050AH1AA")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/ESH227M050AH1AA.pdf")
		(attr "<Component Height>" "13.5")
		(attr "<STEP Filename>" "ESH227M050AH1AA.stp")
		(attr "<STEP Offsets>" "X=2.5;Y=0;Z=14")
