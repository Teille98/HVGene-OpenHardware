...
//11311345/1514719/2.50/2/3/Schottky Diode
...
(library Library_1
	...
	(symbolDef "SB160-E3_54" (originalName "SB160-E3_54")
	...
	(compDef "SB160-E3_54" (originalName "SB160-E3_54") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SB160-E3_54"))
		...
		(attr "Mouser Part Number" "625-SB160-E3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-General-Semiconductor/SB160-E3-54?qs=u91jd7aysvPQGAQKmVmbIA%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SB160-E3/54")
		(attr "Description" "Schottky Diodes & Rectifiers 60 Volt 1.0 Amp 50 Amp IFSM")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/SB160-E3_54.pdf")
		(attr "<STEP Filename>" "SB160-E3_54.stp")
